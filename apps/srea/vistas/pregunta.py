...
class PreguntaListView(LoginRequiredMixin,ValidatePermissionRequiredMixin,ListView): #Primera vista basada en clase ListView, permite sobrescribir métodos
    model= Pregunta#Primero se indica el modelo o entidad
    template_name = 'pregunta/pregunta_lista.html' #Indicarle cual es la plantilla
